...
int main()
{
    ...
    newCourse[0].setCourse("Introduction to Music", "Music 101");
    newCourse[1].setCourse("Programming 1 c++", "CSCD 202");
    newCourse[2].setCourse("Introduction to Drama", " Drama 421");
    newCourse[3].setCourse("Information Systems", "Info 321");
    newCourse[4].setCourse("Introductin to Agriculture", "Agric 123");

    Staff newStaff[10];
    newStaff[0].setStaff("Mr.Aamoah Williams", "728244");
    newStaff[1].setStaff("Mr. Amoah Francis  ", "202756");
    newStaff[2].setStaff("Mr. Travis Nimo", "19934");
    newStaff[3].setStaff("Mr. Davids Austins", "10234");
    newStaff[4].setStaff("Mr Brown John", "806334");
